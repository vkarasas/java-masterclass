...
public class CodingExercise46 {
    ...
    /*
        Banking System: Branches, Customers & Transactions
    ...
    private static class Bank {
        ...
        public boolean listCustomers(String branchName, boolean transaction) {
            ...
            for(var customer : branch.getCustomers()) {
                System.out.println("Customer: " + customer.getName() + "[" + countC + "]");
                countC++;
                if(transaction) {
                    System.out.println("Transactions");
                    int countT = 1;
                    for(var amount : customer.getTransactions()) {
                        System.out.println("[" + countT + "]" + " Amount " + amount);
                        countT++;
                    }
                }
            }
